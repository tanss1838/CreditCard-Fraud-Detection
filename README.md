...
The dataset downloads automatically if not found locally.

## Files

- `cc_fraud_detection.ipynb` — main notebook
- `saved_models/` — trained model, scaler, and config (generated after running)
